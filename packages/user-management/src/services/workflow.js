...
export const pageListSelfBuildDataApiAddress = '/workflow/pageListSelfBuild';

export async function pageListSelfBuildData(parameters) {
  return request({
    api: pageListSelfBuildDataApiAddress,
    params: parameters,
  });
}

export const pageListSystemDataApiAddress = '/workflow/pageListSystem';

export async function pageListSystemData(parameters) {
  return request({
    api: pageListSystemDataApiAddress,
    params: parameters,
  });
}

export const pageListUsableDataApiAddress = '/workflow/pageListUsable';
