...
class PageList extends MultiPage {
  ...
  showAllModelConfigFileContentDrawer = () => {
    ModelConfigFileContentDrawer.open();
  };

  showInfrastructureModelConfigFileContent = () => {
    ModelConfigInfrastructureDrawer.open();
  };

  showBusinessModelConfigFileContent = () => {
    ModelConfigBusinessDrawer.open();
  };

  showAllPermissionFileContentDrawer = () => {
    PermissionFileContentDrawer.open();
  };

  showBusinessPermissionFileContentDrawer = () => {
    PermissionContentBusinessDrawer.open();
  };

  showInfrastructurePermissionFileContentDrawer = () => {
  ...
  establishExtraActionEllipsisConfig = () => {
    ...
    return {
      ...
      handleMenuClick: ({ key, handleData }) => {
        switch (key) {
          case 'showAllModelConfigFileContent': {
            that.showAllModelConfigFileContentDrawer();
            break;
          }

          case 'showInfrastructureModelConfigFileContent': {
            that.showInfrastructureModelConfigFileContent();
            break;
          }

          case 'showBusinessModelConfigFileContent': {
            that.showBusinessModelConfigFileContent();
            break;
          }

          case 'showAllPermissionFileContent': {
            that.showAllPermissionFileContentDrawer();
            break;
          }

          case 'showInfrastructurePermissionFileContentDrawer': {
            that.showInfrastructurePermissionFileContentDrawer();
            break;
          }

          case 'showBusinessPermissionFileContentDrawer': {
            that.showBusinessPermissionFileContentDrawer();
            break;
          }
      ...
      items: [
        {
          key: 'showAllModelConfigFileContent',
          icon: iconBuilder.read(),
          text: '查看前端全部 Model 配置文件',
          hidden: !checkHasAuthority(
            accessWayCollection.accessWay.getAllModelConfigFileContent
              .permission,
          ),
        },
        {
          key: 'showInfrastructureModelConfigFileContent',
          icon: iconBuilder.read(),
          text: '查看前端基础 Model 配置文件',
          // hidden: !checkHasAuthority(
          //   accessWayCollection.accessWay
          //     .getInfrastructureModelConfigFileContent.permission,
          // ),
        },
        {
          key: 'showBusinessModelConfigFileContent',
          icon: iconBuilder.read(),
          text: '查看前端业务 Model 配置文件',
          // hidden: !checkHasAuthority(
          //   accessWayCollection.accessWay.getBusinessModelConfigFileContent
          //     .permission,
          // ),
        },
        {
        ...
        {
          key: 'showAllPermissionFileContent',
          icon: iconBuilder.read(),
          text: '查看前端全部权限文件',
          hidden: !checkHasAuthority(
            accessWayCollection.accessWay.getAllPermissionFileContent
              .permission,
          ),
        },
        {
          key: 'showInfrastructurePermissionFileContentDrawer',
          icon: iconBuilder.read(),
          text: '查看前端基础权限文件',
          // hidden: !checkHasAuthority(
          //   accessWayCollection.accessWay.getInfrastructurePermissionFileContent
          //     .permission,
          // ),
        },
        {
          key: 'showBusinessPermissionFileContentDrawer',
          icon: iconBuilder.read(),
          text: '查看前端业务权限文件',
          // hidden: !checkHasAuthority(
          //   accessWayCollection.accessWay.getBusinessPermissionFileContent
          //     .permission,
          // ),
        },
      ],
