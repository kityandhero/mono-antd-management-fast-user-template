      ...
      items: [
        {
          ...
          text: '变更权限',
          hidden: !checkHasAuthority(
            accessWayCollection.user.changePermission.permission,
          ),
        },
        {
          withDivider: true,
          ...
          hidden: !checkHasAuthority(
            accessWayCollection.user.setEnable.permission,
          ),
        },
        {
          key: 'setDisable',
          ...
          hidden: !checkHasAuthority(
            accessWayCollection.user.setDisable.permission,
          ),
        },
        {
          withDivider: true,
          ...
          title: '将要移除账户，确定吗？',
          hidden: !checkHasAuthority(
            accessWayCollection.user.remove.permission,
          ),
        },
        {
          withDivider: true,
