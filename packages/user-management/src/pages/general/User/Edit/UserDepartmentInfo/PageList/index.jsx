...
class PageList extends InnerMultiPage {
  ...
  constructor(properties) {
    ...
    this.state = {
      ...
      loadApiPath:
        modelTypeCollection.userDepartmentInfoTypeCollection.pageList,
      ...
      items: [
        {
          ...
          hidden: !checkHasAuthority(
            accessWayCollection.userDepartmentInfo.setPrimary.permission,
          ),
        },
        {
          withDivider: true,
          ...
          title: '将要移除所属关系，确定吗？',
          hidden: !checkHasAuthority(
            accessWayCollection.userDepartmentInfo.remove.permission,
          ),
        },
        {
          withDivider: true,
          ...
          title: '将要刷新缓存，确定吗？',
          hidden: !checkHasAuthority(
            accessWayCollection.userDepartmentInfo.refreshCache.permission,
          ),
        },
      ],
    };
