...
const visibleFlag = 'b361eff2ed8144e8a6f8f8c633d1daaf';
...
class ChangeSortModal extends BaseUpdateModal {
  ...
  constructor(properties) {
    ...
    this.state = {
      ...this.state,
      pageTitle: '排序值设置',
      loadApiPath: modelTypeCollection.workflowNodeApproverTypeCollection.get,
      submitApiPath:
        modelTypeCollection.workflowNodeApproverTypeCollection.updateSort,
    };
  }
  ...
  supplementLoadRequestParams = (o) => {
    ...
    const { workflowNodeApproverId } = externalData;

    d[fieldData.workflowNodeApproverId.name] = workflowNodeApproverId;
