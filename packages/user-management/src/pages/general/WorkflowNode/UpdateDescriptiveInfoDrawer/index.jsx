...
const visibleFlag = '69ff3e1519ca466280e3a22a57ef8ffc';

@connect(({ workflowNode, schedulingControl }) => ({
  workflowNode,
  schedulingControl,
}))
class UpdateDescriptiveInfoDrawer extends BaseUpdateDrawer {
  reloadWhenShow = true;
  ...
  constructor(properties) {
    ...
    this.state = {
      ...
      submitApiPath:
        modelTypeCollection.workflowNodeTypeCollection.updateDescriptiveInfo,
    };
  }
...
export { UpdateDescriptiveInfoDrawer };
