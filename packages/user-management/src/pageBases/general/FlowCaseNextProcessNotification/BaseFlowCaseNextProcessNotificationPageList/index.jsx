...
class BaseFlowCaseNextProcessNotificationPageList extends MultiPage {
  ...
  checkHasGetFlowCaseAuthority = () => {
    throw new Error('checkHasGetFlowCaseAuthority need overrode to implement');
  };
  ...
  showFormDocumentPreviewDrawer = (o) => {
    throw new Error('showFormDocumentPreviewDrawer need overrode to implement');
  };
  ...
  establishListItemDropdownConfig = (record) => {
    return {
      ...
      disabled: !!this.checkHasGetFlowCaseAuthority(),
      ...
      items: [
        {
          ...
          icon: iconBuilder.read(),
          hidden: !this.checkHasGetFlowCaseAuthority(),
          text: '查看表单文档',
        },
        {
