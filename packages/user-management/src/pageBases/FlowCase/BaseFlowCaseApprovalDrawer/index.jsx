...
class BaseFlowCaseApprovalDrawer extends BaseUpdateDrawer {
  ...
  closeSelf = () => {
    throw new Error('closeSelf need overrode to implement');
  };
  ...
  showFlowCaseFormDocumentDrawer = () => {
    this.openFlowCaseFormDocumentDisplayDrawer();
  };
